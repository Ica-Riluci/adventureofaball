var sys = new function() {
    ...
    this.updatecareer = function() {
        ...
        $('#noobs .noobstatus .progressspan').get(0).innerHTML = this.xp(this.hero(0).lv, this.hero(0).pro);
        ...
        $('#allheros .generalstatus .progressspan').get(0).innerHTML = this.xp(this.hero(1).lv, this.hero(1).pro);
        $('#generals .generalstatus .statusspan').get(0).innerHTML = this.lvl(this.hero(1).lv);
        $('#generals .generalstatus .progressspan').get(0).innerHTML = this.xp(this.hero(1).lv, this.hero(1).pro);
        ...
        $('#generals #generalhprestore .cardcontent').get(0).innerHTML = this.hero(1).restore.toString();
        $('#allheros .lordstatus .statusspan').get(0).innerHTML = this.lvl(this.hero(2).lv);
        $('#allheros .lordstatus .progressspan').get(0).innerHTML = this.xp(this.hero(2).lv, this.hero(2).pro);
        $('#lords .lordstatus .statusspan').get(0).innerHTML = this.lvl(this.hero(2).lv);
        $('#lords .lordstatus .progressspan').get(0).innerHTML = this.xp(this.hero(2).lv, this.hero(2).pro);
        ...
        $('#lords #lordbonuspts .cardcontent').get(0).innerHTML = this.hero(2).bonus.toString();
        $('#allheros .samuraistatus .statusspan').get(0).innerHTML = this.lvl(this.hero(3).lv);
        $('#allheros .samuraistatus .progressspan').get(0).innerHTML = this.xp(this.hero(3).lv, this.hero(3).pro);
        $('#samurais .samuraistatus .statusspan').get(0).innerHTML = this.lvl(this.hero(3).lv);
        $('#samurais .samuraistatus .progressspan').get(0).innerHTML = this.xp(this.hero(3).lv, this.hero(3).pro);
        ...
        $('#samurais #samuraitama .cardcontent').get(0).innerHTML = this.hero(3).wall.toString();
    ...
    this.updatehp = function(cur, tot) { $('#herohpcd #herohp #hpinfo').get(0).innerHTML = Math.ceil(cur).toString() +'/' + tot.toString(); }
